...
import Accueil from "./pages/HomeAcceuil";
    ...
    return (
        <div className="App">
            ...
            <Routes>
                ...
                <Route
                    path="/"
                    element={<Accueil setActive={setActive} active={active} user={user} />}
                />
                <Route
                    path="/about"
                    element={<About setActive={setActive} active={active} user={user} />}
                />
                <Route
                    path="/search"
